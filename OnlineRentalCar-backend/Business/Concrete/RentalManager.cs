...
namespace Business.Concrete
{
    public class RentalManager : IRentalService
    {
        ...
        [SecuredOperation("admin,rental.all,rental.list,customer")]
      //  [CacheAspect(10)]
        public IDataResult<List<RentalDetailDto>> GetRentalsByCustomerIdWithDetails(int customerId)
        {
            Trace.WriteLine(_rentalDal.GetRentalsDetails(r => r.CustomerId == customerId).Count);
            Trace.WriteLine("Kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk");
        ...
        [SecuredOperation("admin,rental.all,rental.delete,customer")]
        [CacheRemoveAspect("IRentalService.Get")]
